...
#file = './Simulations/channel_var/Results/old_one_day_sim/results_True_True_1_year_sf_12_100_nodes.p'
file = './Simulations/channel_var/Results/True_True_0.1_cnst_num_bytes.p'
...
plot_retransmitted_packets = False
plot_energy = True
...
for idx_p, p in enumerate(payload_sizes):
    for idx, s in enumerate(sigmas):
        ...
        print(node_data)
        if plot_retransmitted_packets:
            plt.scatter(p, node_data['RetransmittedPackets'], color=color[idx])
        if plot_energy:
